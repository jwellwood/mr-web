import { z } from 'zod';
import { TeamDetailsSchema } from '../add-team/schema';
import { T_EDIT_TEAM_MUTATION_INPUT, T_FETCH_TEAM_QUERY } from './../../graphql';
...
): T_EDIT_TEAM_MUTATION_INPUT['EDIT_TEAM'] => {
  return {
...
export const mapTeamDataToFormData = (team: T_FETCH_TEAM_QUERY['team']): EditTeamFormData => {
  return {
